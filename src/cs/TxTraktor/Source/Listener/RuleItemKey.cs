...
namespace TxTraktor.Source.Listener
{
    internal partial class Main
    {
        ...
        public override void EnterRule_item_everything(CfgGramParser.Rule_item_everythingContext context)
        {
            RuleItem.Key = string.Empty;
            RuleItem.Type = RuleItemType.Everything;
        }
